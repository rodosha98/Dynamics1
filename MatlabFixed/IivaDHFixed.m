...
% L   = Link ( [ Th  d    a   alph])
 ...
 q4 = deg2rad(0); q5 = deg2rad(0); q6 =deg2rad(0); 
  ...
  %% Testing with Inverse Kinematics;
   figure(3)
   % 87.1232   57.6000  -21.6756 -130.4163   71.9684   88.6362
   Rob.plot ( [  deg2rad(87.1232),  deg2rad(57.6000),  deg2rad(-21.6756), deg2rad(-130.4163),   deg2rad(71.9684),  deg2rad(88.6362)])
   Rob.fkine( [deg2rad(87.1232)  deg2rad(57.6000)  deg2rad(-21.6756) deg2rad(-130.4163)   deg2rad(71.9684)  deg2rad(88.6362)])
   
   % Result is point (15, 10, 30). Its the input of Inverse Kinemtics
